import { t as re } from "./scheduler.CcMS3Mw0.js";
import { w as dt } from "./index.CiBn7g07.js";
...
var xt;
const I =
  ((xt = globalThis.__sveltekit_1ue6q3j) == null ? void 0 : xt.base) ?? "";
var Nt;
const ke =
    ((Nt = globalThis.__sveltekit_1ue6q3j) == null ? void 0 : Nt.assets) ?? I,
  Se = "1711005129201",
...
function Re() {
  ...
  async function r() {
    clearTimeout(e);
    try {
      const a = await fetch(`${ke}/app/version.json`, {
  ...
  for (let p = 0; p < c.length; p += 1)
    if (c[p])
      try {
        ...
        if (y instanceof Mt) return { type: "redirect", location: y.location };
        let b = J(y),
          E;
...
function Qt({ url: t, type: n, intent: e, delta: r }) {
  ...
  return G || Bt.forEach((s) => s(i)), a ? null : o;
}
async function B({
  type: t,
  url: n,
  ...
  const d = k,
    m = A;
  f(), (G = !0), X && T.navigating.set(g.navigation), (Z = c);
  let l = h && (await Xt(h));
  if (!l) {
    ...
    l = await te(
      n,
      { id: null },
      await M(new gt(404, "Not Found", `Not found: ${n.pathname}`), {
        url: n,
        params: {},
        route: { id: null },
      }),
  ...
  (history.scrollRestoration = "manual"),
    ...
    L.addEventListener("click", (e) => {
      ...
      if (
        ...
        return;
      if (o || c.reload) {
        Qt({ url: a, type: "link" }) ? (G = !0) : e.preventDefault();
        return;
      }
